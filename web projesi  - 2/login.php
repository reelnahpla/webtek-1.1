...
<html lang="en">
    <head>
      ...
      <title>Ahmet Alphan Reel - Giriş</title>
    </head>
...
<form action="loginyazdir.php" method="post">
Kullanıcı Adı:<br/>
...
<footer class="footer" style="background: #CB433C">

<div class="container">
<p>Bu sitenin tüm hakları gizlidir. Copyright 2019-2020</p>
